...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.work_retail_customer_ldap
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.work_retail_customer_ldap
  (
    creationtm                       STRING,
    employee_sk                       STRING,
  ...
  STORED AS TEXTFILE
  LOCATION '${DB_WORK_DIR}/retail-customer-ldap'
;

USE ${DB_WORK}
;

MSCK REPAIR TABLE work_retail_customer_ldap
;
