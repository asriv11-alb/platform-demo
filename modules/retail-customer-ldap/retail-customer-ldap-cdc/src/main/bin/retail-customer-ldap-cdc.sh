...
fn_run_hive \
    ...
    "${MODULE_HOME}/hive/reconsile-retail-customer-ldap.hql"

fn_run_hive \
	"${MODULE_HOME}" \
    "${MODULE_HOME}/etc/hive/retail-customer-ldap.hive.properties" \
    "${MODULE_HOME}/hive/insert-into-history-retail-customer-ldap.hql"

fn_run_hive \
	"${MODULE_HOME}" \
    "${MODULE_HOME}/etc/hive/retail-customer-ldap.hive.properties" \
    "${MODULE_HOME}/hive/insert-into-current-retail-customer-ldap.hql"
