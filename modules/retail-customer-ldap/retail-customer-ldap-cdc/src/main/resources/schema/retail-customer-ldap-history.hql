...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.history_retail_customer_ldap
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.history_retail_customer_ldap
  (
    creationtm                       STRING,
    employee_sk                       STRING,
...
MSCK REPAIR TABLE history_retail_customer_ldap
;
