...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.work_retail_item
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.work_retail_item
  (
    creationtm                       STRING,
    employee_sk                       STRING,
  ...
  STORED AS TEXTFILE
  LOCATION '${DB_WORK_DIR}/retail-item'
;

USE ${DB_WORK}
;

MSCK REPAIR TABLE work_retail_item
;
