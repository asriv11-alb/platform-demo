...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.history_retail_customer_email
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.history_retail_customer_email
  (
    creationtm                       STRING,
    employee_sk                       STRING,
...
MSCK REPAIR TABLE history_retail_customer_email
;
