...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.history_employee_work_avail
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.history_employee_work_avail
  (
    creationtm                       STRING,
    employee_sk                       STRING,
...
MSCK REPAIR TABLE history_employee_work_avail
;
