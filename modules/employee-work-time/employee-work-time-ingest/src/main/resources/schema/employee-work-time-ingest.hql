...
DROP TABLE
  IF EXISTS
    ${DB_WORK}.work_employee_work_time
;

CREATE EXTERNAL TABLE IF NOT EXISTS ${DB_WORK}.work_employee_work_time
  (
    creationtm                       STRING,
    employee_sk                       STRING,
  ...
  STORED AS TEXTFILE
  LOCATION '${DB_WORK_DIR}/employee-work-time'
;

USE ${DB_WORK}
;

MSCK REPAIR TABLE work_employee_work_time
;
