...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/employee-work-schedule-cdc/etc/hive/employee-work-schedule.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/employee-work-schedule-cdc/etc/schema/employee-work-schedule-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/employee-work-time-cdc/etc/hive/employee-work-time.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/employee-work-time-cdc/etc/schema/employee-work-time-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-champ-cdc/etc/hive/retail-customer-champ.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-champ-cdc/etc/schema/retail-customer-champ-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-ecom-cdc/etc/hive/retail-customer-ecom.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-ecom-cdc/etc/schema/retail-customer-ecom-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-email-cdc/etc/hive/retail-customer-email.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-email-cdc/etc/schema/retail-customer-email-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-ldap-cdc/etc/hive/retail-customer-ldap.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/retail-customer-ldap-cdc/etc/schema/retail-customer-ldap-temp.hql"
...
fn_run_hive \
    "${PROJECT_HOME_DIRECTORY}" \
    "${PROJECT_HOME_DIRECTORY}/retail-item-cdc/etc/hive/retail-item.hive.properties" \
    "${PROJECT_HOME_DIRECTORY}/retail-item-cdc/etc/schema/retail-item-temp.hql"
